    ...
    class Store {
        ...
        class Resume {
            ...
            void pdfExactlyAtSizeLimit_shouldSave() throws Exception {
                ...
                MockMultipartFile file = new MockMultipartFile(
                        "file", "resume.pdf", "application/pdf", new byte[exactLimit]);
                StoredFile saved = buildStoredFile(1L, "resume.pdf", "application/pdf",
            ...
            void nullOriginalFilename_shouldFallbackToFile() throws Exception {
                MockMultipartFile file = new MockMultipartFile(
                        "file", null, "application/pdf", new byte[1024]);
        ...
        class Portfolio {
            ...
            void allowedTypes_shouldSave(String filename, String contentType) throws Exception {
                MockMultipartFile file = new MockMultipartFile("file", filename, contentType, new byte[1024]);
            ...
            void exactlyAtLimit_shouldSave() throws Exception {
                ...
                MockMultipartFile file = new MockMultipartFile(
                        "file", "portfolio.pdf", "application/pdf", new byte[limit]);
        ...
        class Avatar {
            ...
            void exactlyAtLimit_shouldSave() throws Exception {
                ...
                MockMultipartFile file = new MockMultipartFile(
                        "file", "avatar.jpg", "image/jpeg", new byte[limit]);
